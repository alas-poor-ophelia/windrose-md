...
const { LinkedNoteHoverOverlays } = await requireModuleByName("LinkedNoteHoverOverlays.tsx");
...
const { HexCoordinateLayer } = await requireModuleByName("HexCoordinateLayer.tsx");
