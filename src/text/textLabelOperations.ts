...
function getTextLabelAtPosition(
  ...
  let context = ctx;
  if (!context) {
    tempCanvas = activeWindow.createEl('canvas');
...
export { generateTextLabelId, addTextLabel, updateTextLabel, removeTextLabel, getTextLabelAtPosition, removeTextLabelsInRectangle };