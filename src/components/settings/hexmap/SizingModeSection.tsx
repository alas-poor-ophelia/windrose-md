...
import { useBackgroundImage, useHexGrid } from '../../../context/MapSettingsContext';
 ...
 */
function DensityModeContent(): VNode {
  const {
    gridDensity,
    customColumns,
    imageDimensions,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
            ...
            <input
              ...
              max="200"
              value={customColumns}
              onChange={(e: Event) => handleCustomColumnsChange(Number((e.target as HTMLInputElement).value))}
 ...
 */
function MeasurementModeContent(): VNode {
  const {
    measurementMethod,
    measurementSize,
    fineTuneOffset,
      ...
      <SettingItem name="Size">
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <input
            ...
            onChange={(e: Event) => handleMeasurementSizeChange(Number((e.target as HTMLInputElement).value))}
            style={{
              width: '80px',
              padding: '4px 8px',
              borderRadius: '4px',
 ...
 */
function SizingModeSection(): VNode | null {
  const {
    backgroundImagePath,
    imageDimensions,
    sizingMode,
...
export { SizingModeSection, DensityModeContent, MeasurementModeContent };