 ...
 */
function CoordinateModeSection(): VNode {
  const {
 ...
 */
function CoordinateColorsSection(): VNode {
  const {
    useGlobalSettings,
    THEME
  } = useAppearance();
...
export { CoordinateDisplaySection, CoordinateModeSection, CoordinateColorsSection };