...
export { // Normalization
  normalizeEdge, // ID generation
  generateEdgeId, // Single edge operations
  getEdgeAt, addEdge, removeEdge, removeEdgeById, updateEdge, // Line operations (for edge line tool)
  generateEdgeLine, mergeEdges, removeEdgeLine, // Query operations
  getEdgesForCell, // Bulk operations
  clearAllEdges };