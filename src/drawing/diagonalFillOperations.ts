...
import type { CornerName, DiagonalDirection } from '../core/dmtConstants';

import { CORNER_SEGMENT_FILL, CORNER_NEIGHBOR_CHECKS, CORNER_DIAGONAL_DIRECTION } from '../core/dmtConstants';
import { isSimpleCell, hasSegments } from '../geometry/core/cellAccessor';
...
export { // Corner detection
  getNearestCorner, getLocalPosition, // Cell state helpers
  cellIsPainted, cellIsEmpty, getCell, // Concave corner validation
  isValidConcaveCorner, findValidCornerForCell, findNearestValidCorner, // Diagonal path calculation
  isValid45Diagonal, getDiagonalDirection, cornerMatchesDiagonal, getCellsAlongDiagonal, getValidCornersAlongDiagonal, // Color inheritance
  getInheritedColor, // Segment helpers
  getSegmentsForCorner, // Preview validation
