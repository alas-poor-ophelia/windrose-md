...
const { useEventHandlerRegistration } = await dc.require(dc.headerLink(dc.resolvePath("compiled-windrose-md"), "EventHandlerContext"));
const { useMapOperations } = await dc.require(dc.headerLink(dc.resolvePath("compiled-windrose-md"), "MapContext"));
...
const { getDisplayNameFromPath } = await dc.require(dc.headerLink(dc.resolvePath("compiled-windrose-md"), "imageOperations"));
