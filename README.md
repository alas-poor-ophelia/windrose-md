...
<!-- Screenshot: Full interface with a mapped dungeon -->
...
<!-- Screenshot: Drawing tools in action, maybe mid-rectangle -->
...
<!-- Screenshot: Object sidebar with some placed objects -->
