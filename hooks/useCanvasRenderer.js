...
const { gridRenderer } = await requireModuleByName("gridRenderer.ts");
const { hexRenderer } = await requireModuleByName("hexRenderer.ts");
const { segmentRenderer } = await requireModuleByName("segmentRenderer.ts");
